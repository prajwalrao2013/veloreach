...
function App() {
  ...
  const renderContent = () => {
    let Component;
    switch (activeTab) {
      case 'extractors': Component = <LeadExtractor />; break;
      case 'dashboard': Component = <LeadDashboard />; break;
      case 'bulk': Component = <BulkEngine />; break;
      case 'inbox': Component = <PriorityInbox />; break;
      case 'ai_assistant': Component = <AiAssistant />; break;
      case 'safety': Component = <AntiBanSettings />; break;
      case 'help': Component = <HelpCenter />; break;
      default: Component = <LeadDashboard />; break;
    }
    return <ErrorBoundary key={activeTab}>{Component}</ErrorBoundary>;
  };
